...
export default function VerifyCard() {
  ...
  return (
    <div
    className="w-full max-w-3xl mx-auto rounded-[28px] p-[6px] bg-gradient-to-r from-orange-400 via-red-500 to-orange-400 shadow-[0_14px_30px_rgba(185,28,28,0.12),0_6px_12px_rgba(249,115,22,0.06)] "
    >
